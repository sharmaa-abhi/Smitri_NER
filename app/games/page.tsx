      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {games.map((game, idx) => {
          ...
          return (
            ...
            >
              <div
                className="bg-white rounded-2xl p-6 border border-slate-200/90 shadow-sm hover:border-blue-400 hover:shadow-md transition-all flex flex-col justify-between space-y-5 h-full"
              >
