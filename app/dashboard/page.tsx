    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <ScrollReveal direction="up" delay={120}>
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/90 shadow-sm space-y-2.5 h-full">
        ...
        <ScrollReveal direction="up" delay={180}>
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/90 shadow-sm space-y-2.5 h-full">
            ...
            <div className="flex items-baseline gap-1.5">
              <span className="text-3xl sm:text-4xl font-black text-teal-800">{gamesCompleted}</span>
              <span className="text-lg font-bold text-slate-600">/ 3 Today</span>
            </div>
            <p className="text-xs font-semibold text-blue-700 bg-blue-50 px-2.5 py-1 rounded-md border border-blue-200 inline-block">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <ScrollReveal direction="left" delay={150}>
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/90 shadow-sm space-y-4 h-full">
            <div className="flex items-center justify-between">
              <div>
        ...
        {/* Right: Today's Routine Reminders */}
        <ScrollReveal direction="right" delay={200}>
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/90 shadow-sm space-y-4 h-full">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg sm:text-xl font-extrabold text-slate-900">Today's Reminders</h3>
                <p className="text-xs sm:text-sm text-slate-600 font-medium">Check off activities as you do them</p>
              </div>
              <Link
                href="/reminders"
                className="text-xs sm:text-sm font-bold text-blue-700 hover:text-blue-900 flex items-center gap-1"
              ...
              {reminders.slice(0, 3).map((rem: any) => (
                <div
                  ...
                  className={`p-3.5 rounded-xl border flex items-center justify-between transition-all cursor-pointer ${
                    rem.isCompleted ? 'bg-slate-50 border-slate-200 opacity-60' : 'bg-slate-50/50 hover:bg-blue-50/40 border-slate-200'
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    <button
