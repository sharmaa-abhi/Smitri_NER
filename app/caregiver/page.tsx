  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/90 shadow-sm space-y-1">
          <span className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Current Score</span>
          <div className="text-2xl sm:text-3xl font-black text-blue-900">{currentScore} <span className="text-sm font-semibold text-slate-600">/ 100</span></div>
          <span className="text-xs font-medium text-slate-600">Latest session benchmark</span>
        </div>

        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/90 shadow-sm space-y-1">
          <span className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Avg Accuracy</span>
          <div className="text-2xl sm:text-3xl font-black text-teal-800">{avgAccuracy}%</div>
          <span className="text-xs font-medium text-slate-600">Across 7 days</span>
        </div>

        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/90 shadow-sm space-y-1">
          <span className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Avg Response Time</span>
          <div className="text-2xl sm:text-3xl font-black text-amber-800">{avgResponse}s</div>
          <span className="text-xs font-medium text-slate-600">Time per challenge</span>
        </div>

        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200/90 shadow-sm space-y-1">
          <span className="text-[11px] font-bold uppercase tracking-wider text-slate-600">Reminder Adherence</span>
          <div className="text-2xl sm:text-3xl font-black text-emerald-800">{reminderRate}%</div>
          <span className="text-xs font-medium text-slate-600">Medicines & routines completed</span>
        </div>
      </div>
